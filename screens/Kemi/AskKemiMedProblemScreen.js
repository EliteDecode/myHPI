...
const AskKemiMedProblemScreen = ({ route }) => {
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      if (response) {
        ...
        await AsyncStorage.setItem(
          `keMiMedicalProblemsCodes_${user?.data?._id}`,
  ...
  return (
    <>
      ...
      <BackButton
        ...
        content="Medical Diagnosis (Problems)"
        font="bold"
      />
...
export default AskKemiMedProblemScreen;
